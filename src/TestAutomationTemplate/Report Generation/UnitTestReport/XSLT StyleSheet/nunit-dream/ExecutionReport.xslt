  ...
  <xsl:template match="/">
    ...
    <html>
      <head>
        ...
        <link rel="stylesheet" href="http://jenkins.openboxsoftware.com:8080/userContent/UnitTestReportStyles/bootstrap.css" type="text/css" />
        <link rel="stylesheet" href="http://jenkins.openboxsoftware.com:8080/userContent/UnitTestReportStyles/style.css" data-noprefix="" />
        <style>
          <![CDATA[
...
position:relative;
      ...
      <body>
        <div class="container">
		  <h1>Unit and Integration Test Execution Report</h1>
          <h2>Summary</h2>
          ...
          <table class="table table-bordered table-hover" cellpadding="0" cellspacing="0">
            <tr>
              <th class="top left">Test Classes</th>
            ...
            <tr>
              <td class="left">
                <xsl:value-of select="count(//nunit:test-suite[@type='TestFixture'])"/> Test Classes
              </td>
          ...
          <table class="table table-bordered" cellpadding="0" cellspacing="0">
            <tr>
              <th class="top left" colspan="2">Test Class</th>
              <th class="top" colspan="2">Success rate</th>
              <th class="top rotated-text-container">
                <span class="rotated-text">Scenarios</span>
              </th>
        ...
        <![CDATA[
        <script src="http://jenkins.openboxsoftware.com:8080/userContent/UnitTestReportStyles/bootstrap.js"></script>
        <script src="http://jenkins.openboxsoftware.com:8080/userContent/UnitTestReportStyles/prism.js"></script>
        <script src="http://jenkins.openboxsoftware.com:8080/userContent/UnitTestReportStyles/prism-gherkin.js"></script>
        <script src="http://jenkins.openboxsoftware.com:8080/userContent/UnitTestReportStyles/prism-bash.js"></script>
        ]]>
        </xsl:text>
      </body>
    </html>
